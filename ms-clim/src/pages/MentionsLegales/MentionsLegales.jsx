...
const D = "Responsabilité civile décenale des entreprises de construction RCDA-278519527";
  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <strong>Attestation d’Aptitude catégorie 1 :</strong> Attestation N° AF 240419-05
        </li>
        <li>
          <strong>Responsabilité civile professionnelle :</strong> {D}
        </li>
        <li>
          <strong>Zone d'activité :</strong> Vosges (88) &amp; Meurthe-et-Moselle (54)
        </li>
        <li>
          <strong>Téléphone :</strong> <a href={`tel:${TEL}`}>{TEL}</a>
        </li>
        <li>
          <strong>E-mail :</strong> <a href={`mailto:${MAIL}`}>{MAIL}</a>
        </li>
      </ul>
      ...
      <h2>Hébergement</h2>
      <p>
        Ce site est hébergé par un prestataire tiers. Les coordonnées de l'hébergeur sont disponibles sur simple demande adressée à{" "}
      ...
      <p>
        Toute reproduction, représentation, modification ou exploitation, totale ou partielle, des contenus de ce site, par quelque procédé que ce
        soit, sans autorisation préalable écrite, est strictement interdite et constituerait une contrefaçon.
      </p>
      ...
      <div className="pl__encadre">
        <p>
          <strong>Date de dernière mise à jour :</strong> mai 2025 — Pour toute question relative aux mentions légales, contactez-nous à{" "}
          <a href={`mailto:${MAIL}`}>{MAIL}</a>.
        </p>
      </div>
    </PageLegal>
